...
export const Cleaning_fees = 'Cleaning fees';
...
export const Travellers_on_this_trip = 'Travellers on this trip';
export const Charges = 'Charges';
export const Total = 'Total';
export const Payment = 'Payment';
export const Total_Remaining = 'Total Remaining';
export const Add_billing_details = 'Add billing details';
export const Cost_per_traveler = 'Cost per traveler';
export const This_trip_was = 'This trip was';
export const per_person_per_night = 'per person per night';
export const including_taxes_and_other_fees = 'including taxes and other fees';
export const Need_help = 'Need help';
export const Visit_the = 'Visit the';
export const for_any_questions = 'for any questions';
export const Booked_by = 'Booked by';
export const Certain_fees_and_taxes_may_be_nonrefundable = 'Certain fees and taxes may be non-refundable. See here for more details';
export const conversion_fee_was_applied_to_this_booking = 'A 3% conversion fee was applied to this booking.';
export const PopulStay_Payments_UK_Ltd_is_a_limited_collection_agent_of_your_Host = 'PopulStay Payments UK Ltd. ("Airbnb Payments") is a limited collection agent of your Host. This means that upon your payment of the Total Fees to PopulStay Payments, your payment obligation to your Host is satisfied. Refund requests will be processed in accordance with: (i) the Host'+'s cancellation policy (available on the Listing); or (ii) PopulStay Payment'+'s Guest Refund Policy Terms, available at ';
export const Questions_or_complaints_contact_Airbnb_Payments = 'Questions or complaints contact Airbnb Payments';
export const Payment_processed_by = 'Payment processed by';
export const PopulStay_Payments_UK_Ltd = 'PopulStay Payments UK Ltd';
export const ComptonSt = '40 Compton St';
export const London = 'London';
export const EC1V_0AP = 'EC1V 0AP';
export const United_Kingdom = 'United Kingdom';
export const PopulStay_Ireland_UC = 'PopulStay Ireland UC';
export const The_Watermarque_Building = 'The Watermarque Building';
export const South_Lotts_Road = 'South Lotts Road';
