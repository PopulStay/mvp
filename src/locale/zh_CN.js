...
export const start_date = '入住时间';
export const end_date = '退房时间';
export const guests = '宾客';
export const location = '城市';
export const Find_dream = '寻找梦想';
export const HOMES = '房源';
export const EXPERIENCE = '体验';
export const Homes_around_the_world = '世界各地的房源';
export const Show_all = '显示全部';
...
export const PPS_Enabled = 'PPS已启用';
export const Shopping_Center = '购物中心';
export const Souvenir_Shop = '纪念品商店';
export const Guide = '指南';
export const Daily_Price = '每日价格';
export const Check_In = '入住';
export const Check_Out = '退房';
export const Guest = '宾客';
export const nights = '晚';
export const Special_Offer_20_off = '特别优惠20％优惠';
export const Long_stay_discount = '长期优惠';
export const Cleaning_fees = '清洁费';
...
export const Consummate_user_information = '完善用户信息';
export const Please_enter_the_mailbox = '请输入邮箱';
export const Incorrect_mailbox_format = '邮箱格式不正确';
export const Email_is_already_registered = '该邮箱已被注册';
...
export const Please_Remember_Your_Pirvate_Key = '请记住你的私钥';
export const Private_Key = '私钥';
export const Please_clear_your_account = '请清除你的帐户';
...
export const Adults = '客人';
export const Adult = '成人';
export const children = '孩子';
export const years_old = '2-12岁';
export const Baby = '婴儿';
export const Under_2_years_of_age = '2岁以下';
export const Support_PPS_token = '支持PPS令牌';
export const Whole_house = '整个房源';
export const Enjoy_the_entire_listing = '独享整个房源';
export const Private_Room = '独立房间';
export const Have_your_own_separate_room_and_share_some_public_space = '有自己的独立房间，共用一些公共空间';
...
export const Introduce_guests_to_the_activities = '向客人介绍您最感兴趣的活动和地点。 我们会帮助您一步一步设计您的体验，并沿途提供大量资源';
export const Share_your_passion_with_the_world = '与世界分享你的激情';
export const Meet_interesting_people = '认识有趣的人';
export const Connect_with_a_community = '与分享您兴趣的旅行者和当地人社区联系。';
export const You_might_make_a_few_new_friends = '你可以结交几个新朋友，向其他爱好者学习，或者让某个人对新的兴趣感到兴奋。';
export const This_experience_is_made_possible = 'Tonie在爱尔兰的LGBTQ历史上拥有丰富的专业知识，使这种体验成为可能。';
...
export const Brain_Lin_introduction = '公司创始人兼首席品牌运营官，上海交通大学中国商学院法学院教授，曾任大中华区数字营销总监杨实。 连续创业者，时间形象文化传媒创始人和狮子航空健身投资管理合伙人，创始人，想成为知识薪酬领域的进化兔，负责业务开发和运营。';
export const Tamir_Wu = '吴韬';
export const Tamir_Wu_introduction = '合作创始人和市场业务拓展了上海同济大学的房地产和城市建设，结合了科技创始人。 是金服与国内着名装饰，家具和家电企业等共同搭建的航天产业链联盟。 致力于打造高品质，低成本，高效率的供应链服务体系。 为了更好的生活';
...
export const Do_i_have_to_host_a_home_to_host_an_experience = '我是否必须托管一个家来承载体验？';
export const No_You_dont_have_to_host_guests = '不需要。您不必在您的家中或空间过夜接待客人以成为体验主持人。';
export const Whats_the_time_commitment = '什么时间承诺？';
export const You_can_host_as_often_as_you_like = '您可以随时随地主持活动 - 随时调整日期和时间，直到找到最适合您的方式。';
export const Do_i_need_a_business_license = '我需要营业执照吗？';
...
// Receipt--------------------------------------------------------------------------------------------
export const To_Itinerary = '行程';
export const Print = '打印';
export const Confirmed = '确认';
export const order_number = '订单号';
export const Travellers_on_this_trip = '位旅行的旅客';
export const Charges = '收费';
export const Total = '总计';
export const Payment = '付款';
export const Total_Remaining = '总剩余';
export const Add_billing_details = '添加结算明细';
export const Cost_per_traveler = '每位旅客的费用';
export const This_trip_was = '这次旅行是';
export const per_person_per_night = '每人每晚';
export const including_taxes_and_other_fees = '包括税金和其他费用';
export const Need_help = '需要帮忙';
export const Visit_the = '访问';
export const for_any_questions = '如有任何问题';
export const Booked_by = '预定';
export const Certain_fees_and_taxes_may_be_nonrefundable = '某些费用和税金可能不予退还。详情请看这里';
export const conversion_fee_was_applied_to_this_booking = '此预订适用3％的转换费用。';
export const PopulStay_Payments_UK_Ltd_is_a_limited_collection_agent_of_your_Host = 'PopulStay Payments UK Ltd.（“Airbnb Payments”）是您的主持人的有限代理人。这意味着，在您将总费用支付给PopulStay付款后，您对主人的付款义务即告满足。退款请求将按照以下方式进行处理：（i）主持人的取消政策（可在上市）; 或（ii）PopulStay付款的客人退款政策条款，请访问';
export const Questions_or_complaints_contact_Airbnb_Payments = '问题或投诉：请致电+44 203 318 1111与潮箱付款联系。';
export const Payment_processed_by = '付款处理方式';
export const PopulStay_Payments_UK_Ltd = '英国潮箱支付有限责任公司';
export const ComptonSt = '康普顿街40号';
export const London = '伦敦';
export const EC1V_0AP = 'EC1V 0AP';
export const United_Kingdom = '英国';
export const PopulStay_Ireland_UC = '潮箱爱尔兰加州大学';
export const The_Watermarque_Building = 'Watermarque建筑';
export const South_Lotts_Road = '南洛茨路';
