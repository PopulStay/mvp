...
class ListingCreate extends Component {
    ...
    nextStep() {
      ...
      // reactLocalStorage.setObject('test', 
      //   this.state
      // )  
      // reactLocalStorage.setObject('test', 
      // {
      //   'step':this.state.step,
      //   'roomtype_category': this.state.roomtype_category,
      //   'roomtype_guests': this.state.roomtype_guests,
      //   'roomtype_location': this.state.roomtype_location,
      //   'roomdescription_homeorhotel': this.state.roomdescription_homeorhotel,
      //   'roomdescription_type': this.state.roomdescription_type,
      //   'roomdescription_guests_have': this.state.roomdescription_guests_have,
      //   'roomdescription_forguestorhost': this.state.roomdescription_forguestorhost,
      //   'roomdescription_title': this.state.roomdescription_title,
      //   'roomdescription_phone': this.state.roomdescription_phone,
      //   'roomdescription_description': this.state.roomdescription_description,
      //   'roombasics_guestsnumber': this.state.roombasics_guestsnumber,
      //   'roombasics_guestbedrooms': this.state.roombasics_guestbedrooms,
      //   'roombasics_guestbeds': this.state.roombasics_guestbeds,
      //   'roombasics_totalguests': this.state.roombasics_totalguests,
      //   'roombasics_commonspacebeds': this.state.roombasics_commonspacebeds,
      //   'roomstuff_Essentials': this.state.roomstuff_Essentials,
      //   'roomstuff_Shampoo': this.state.roomstuff_Shampoo,
      //   'roomstuff_Closet_drwers': this.state.roomstuff_Closet_drwers,
      //   'roomstuff_TV': this.state.roomstuff_TV,
      //   'roomstuff_Pool': this.state.roomstuff_Pool,
      //   'roomstuff_kitchen': this.state.roomstuff_kitchen,
      //   'roomstuff_washer': this.state.roomstuff_washer,
      //   'roomstuff_dryer':this.state.roomstuff_dryer,
      //   'roomstuff_Park':this.state.roomstuff_Park,
      //   'roomstuff_Lift':this.state.roomstuff_Lift,
      //   'roomstuff_HotTub':this.state.roomstuff_HotTub,
      //   'roomstuff_Gym':this.state.roomstuff_Gym,
      //   'roomstuff_Heat':this.state.roomstuff_Heat,
      //   'roomstuff_aircondition':this.state.roomstuff_aircondition,
      //   'roomstuff_breakfastcoffetea':this.state.roomstuff_breakfastcoffetea,
      //   'roomstuff_desk_workspace':this.state.roomstuff_desk_workspace,
      //   'roomstuff_fireplace':this.state.roomstuff_fireplace,
      //   'roomstuff_iron':this.state.roomstuff_iron,
      //   'roomstuff_withKids':this.state.roomstuff_withKids,
      //   'roomstuff_BigGroups':this.state.roomstuff_BigGroups,
      //   'roomstuff_pets':this.state.roomstuff_pets,
      //   'roomstuff_hairdryer':this.state.roomstuff_hairdryer,
      //   'roomstuff_petsinhouse':this.state.roomstuff_petsinhouse,
      //   'roomstuff_private_entrance':this.state.roomstuff_private_entrance,
      //   'roomstuff_smartpincode':this.state.roomstuff_smartpincode,
      //   'roomstuff_smartpincode_password':this.state.roomstuff_smartpincode_password,
      //   'roomstuff_smartpincode_confirmpassword':this.state.roomstuff_smartpincode_confirmpassword,
      //   'roomstuff_smoke_detector':this.state.roomstuff_smoke_detector,
      //   'roomstuff_Country':this.state.roomstuff_Country,
      //   'roomstuff_Street':this.state.roomstuff_Street,
      //   'roomstuff_Apt':this.state.roomstuff_Apt,
      //   'roomstuff_City':this.state.roomstuff_City,
      //   'roomstuff_ZIPCode' :this.state.roomstuff_ZIPCode,
      //   'roomdescription_Aboutyour':this.state.roomdescription_Aboutyour,
      //   'roomdescription_guestscan':this.state.roomdescription_guestscan,
      //   'roomdescription_interaction':this.state.roomdescription_interaction,
      //   'roomdescription_Otherthings':this.state.roomdescription_Otherthings,
      //   'roomdescription_neighbourhood':this.state.roomdescription_neighbourhood,
      //   'roomdescription_around':this.state.roomdescription_around,
      //   'roomstuff_submittedPopulStay':this.state.roomstuff_submittedPopulStay,
      //   'roomdescription_Confirmtime':this.state.roomdescription_Confirmtime,
      //   'roomdescription_manyguests':this.state.roomdescription_manyguests,
      //   'roomdescription_Message':this.state.roomdescription_Message,
      //   'roomdescription_Rules':this.state.roomdescription_Rules,
      //   'roomdescription_information':this.state.roomdescription_information,
      //   'roomdescription_Confirmedphone':this.state.roomdescription_Confirmedphone,
      //   'roomdescription_Email':this.state.roomdescription_Email,
      //   'roomstuff_Recommended':this.state.roomstuff_Recommended,
      //   'rules_parties':this.state.rules_parties,
      //   'rules_Smoking':this.state.rules_Smoking,
      //   'rules_pets':this.state.rules_pets,
      //   'rules_infants':this.state.rules_infants,
      //   'rules_children':this.state.rules_children,
      //   'climb_stairs':this.state.climb_stairs,
      //   'property_animals':this.state.property_animals,
      //   'property_Weapons':this.state.property_Weapons,
      //   'property_recording':this.state.property_recording,
      //   'Amenity_limitations':this.state.Amenity_limitations,
      //   'shared_spaces':this.state.shared_spaces,
      //   'property_parking':this.state.property_parking,
      //   'property_Pet':this.state.property_Pet,
      //   'Potential_noise':this.state.Potential_noise,
      //   'Payment_information':this.state.Payment_information,
      //   'guest_message':this.state.guest_message,
      //   'last_time':this.state.last_time,
      //   'governmentissued_ID':this.state.governmentissued_ID,
      //   'Not_safe':this.state.Not_safe,
      //   'anytime_Checkin':this.state.anytime_Checkin,
      //   'NO_shoes':this.state.NO_shoes,
      //   'roomstuff_AreaCode':this.state.roomstuff_AreaCode,
      //   'selectedPictures':this.state.selectedPictures,
      //   'firstPictures':this.state.firstPictures,
      //   'Currency':this.state.Currency,
      //   'price_perday':this.state.price_perday,
      //   'ETHprice_perday':this.state.ETHprice_perday,
      //   'USDprice_perday':this.state.USDprice_perday,
      //   'maxprice_perday':this.state.maxprice_perday,
      //   'minprice_perday':this.state.minprice_perday,
      //   'Explainwhy':this.state.Explainwhy,
      //   'question_rented':this.state.question_rented,
      //   'Howoften_guests':this.state.Howoften_guests,
      //   'notice_arrives':this.state.notice_arrives,
      //   'Howoften_From':this.state.Howoften_From,
      //   'Howoften_To':this.state.Howoften_To,
      //   'advance_book':this.state.advance_book,
      //   'Price_demand':this.state.Price_demand,
      //   'Price_fixed':this.state.Price_fixed,
      //   'first_guests_20':this.state.first_guests_20,
      //   'Welcome_guests':this.state.Welcome_guests,
      //   'confirmation_booking':this.state.confirmation_booking,
      //   'requirements_book':this.state.requirements_book,
      //   'starting_host':this.state.starting_host,
      //   'uncomfortable_controls':this.state.uncomfortable_controls,
      //   'listing_lower':this.state.listing_lower,
      //   'hours_respond':this.state.hours_respond,
      //   'discount_Weekly':this.state.discount_Weekly,
      //   'discount_Monthly':this.state.discount_Monthly,
      //   'PasswordActibve':this.state.PasswordActibve,
      //   'Step3_13Actibve':this.state.Step3_13Actibve,
      //   'Rapair':this.state.Rapair,
      //   'scene':this.state.scene,
      //   'modalset':this.state.modalset,
      //   'modalimg':this.state.modalimg,
      //   'rotate':this.state.rotate,
      //   'range':this.state.range,
      //   'AdditionalRules':this.state.AdditionalRules,
      //   'RulesIpt':this.state.RulesIpt,
      //   'modalIsOpen':this.state.modalIsOpen,
      //   'guests_check':this.state.guests_check,
      //   'phoneactive':this.state.phoneactive,
      //   'guests_know':this.state.guests_know,
      //   'Date_year': this.state.Date_year,
      //   'Date_month':  this.state.Date_month,
      //   'Date_day':  this.state.Date_day,
      //   'Date_week':  this.state.Date_week,
      //   'Date_Months': this.state.Date_Months,
      //   'Date_List': this.state.Date_List,
      //   'canvasW': this.state.canvasW,
      //   'canvasH':this.state.canvasH,
      //   'canvasRotate':this.state.canvasRotate,
      //   'canvasScale':this.state.canvasScale,
      //   'editor':this.state.editor,
      //   'photosindex':this.state.photosindex,
      //   'modalsubmit':this.state.modalsubmit,
      //   'PicturesSize':this.state.PicturesSize
      // });
