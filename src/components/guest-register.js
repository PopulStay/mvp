  ...
  render() {
    ...
    <div>
...

        {
          ...
          <Link to="/managepanel"><button onClick={(e) => window.location.href="/managepanel"} className="logoutButton float-right">Welcome！{this.state.user}<span></span></button></Link>
